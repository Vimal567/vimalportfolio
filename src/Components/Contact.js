...
export default function Contact(){
    ...
    return(
        <div id="Contact">
            <div className="contact-heading"><img alt="contact logo" src={contact} /><h2>Contact</h2></div>
                ...
                <Row>
                    ...
                    <Card className="contact-card">
                        <Card.Body className="contact-body">
                            <br />
                            <h2>GET IN <span style={{color:"rgb(115, 3, 167)"}}>TOUCH</span></h2>
                            <br />
                    ...
                    <Card className="contact-card">
                        <Card.Body className='contact-form-card'>
                            <Form action="https://formsubmit.co/e87f7629bc8f96a6f86f82948b669cc6" method="POST">
            ...
            <br />
            <div className="madeby">Made with <img alt="heart logo" src={heart} className='heart' /> by Vimal</div>
        </div>
    )
}